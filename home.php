...
<ul class="w3-navbar w3-black w3-card-2 w3-left-align">
  ...
  <li class="w3-hide-small"><a href="new_login.php" class="w3-padding-large">LOGIN</a></li>
  <li class="w3-hide-small"><a href="new_register.php" class="w3-padding-large">CREATE ACCOUNT</a></li>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="mySlides w3-display-container w3-center">
      <img src="images/Health-and-Fitness.jpg" style="width:100%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      </div>
  </div>
  <div class="mySlides w3-display-container w3-center">v
      <img src="images/thefitpost040.jpg" style="width:100%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      
    </div>
  </div>
  <div class="mySlides w3-display-container w3-center">
      <img src="images/fitness_tracker_guide_cover_2.jpg" style="width:100%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
